        ...
        return (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4 animate-fadeIn overflow-y-auto">
            <div className="bg-white rounded-lg w-full max-w-6xl shadow-2xl border border-gray-300 flex flex-col animate-slideUp my-4" style={{ maxHeight: 'calc(100vh - 2rem)' }}>
              ...
              <div className={`bg-gradient-to-r ${selectedQuote.documentType === 'factura' ? 'from-green-600 via-emerald-600 to-teal-600' : 'from-green-600 via-indigo-600 to-purple-600'} px-3 sm:px-4 py-2 sm:py-3 flex items-center justify-between border-b ${selectedQuote.documentType === 'factura' ? 'border-teal-700' : 'border-indigo-700'} shadow-lg flex-shrink-0`}>
