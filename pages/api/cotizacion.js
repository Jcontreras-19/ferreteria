    ...
    if (skipWebhook) {
      ...
      if (!n8nWebhookUrl) {
        ...
        try {
          ...
          // IMPORTANTE: No sobrescribir quote.products porque contiene notFoundProducts
          // El generador parseará quote.products y extraerá tanto items como notFoundProducts
