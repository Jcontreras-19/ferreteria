...
export default function ProductCard({ product, darkMode = false }) {
  ...
  if (darkMode) {
    return (
      <>
        <div className="bg-white rounded-3xl shadow-2xl hover:shadow-green-500/30 overflow-hidden transition-all duration-500 transform hover:-translate-y-4 border border-gray-200 hover:border-green-500/60 group relative">
          {/* Badge de categoría flotante */}
          {product.category && (
            <div className="absolute top-4 left-4 z-20">
              <div className="flex items-center gap-1.5 bg-green-600 px-3 py-1.5 rounded-full border border-green-700 shadow-lg">
          ...
          {/* Imagen del producto con overlay mejorado - Área más grande */}
          <div className="relative w-full h-72 bg-gradient-to-br from-gray-50 via-white to-gray-50 group overflow-hidden">
            ...
            {/* Indicador de stock en la esquina inferior - Más visible o removido */}
            {product.stock !== undefined && product.stock <= 10 && (
              <div className="absolute bottom-4 left-4 z-20">
                <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold shadow-lg border-2 ${
                  product.stock > 10
                  ...
                  <FiPackage size={14} />
                  <span>{product.stock > 0 ? `Solo ${product.stock}` : 'Agotado'}</span>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="p-6 bg-white">
            ...
            {/* Descripción más clara - Más compacta */}
            {product.description && (
            ...
            {/* Información adicional si no está autenticado - Solo muestra si stock es bajo */}
            {!isAuthenticated && product.stock !== undefined && product.stock <= 10 && (
